...
svmdiabetes2<-svm(DIABETICEV ~SALADSNO+ VIG10DMIN+HINOTCOVE+HOURSWRK+EDUC, data=train, kernel="linear", cost=0.05, scale=TRUE)
...
```{r}
svmdiabetes_poly2<-svm(DIABETICEV ~SALADSNO+ VIG10DMIN+HINOTCOVE+HOURSWRK+EDUC, data=train, kernel="polynomial",degree=2, cost=0.5, scale=TRUE)
...
```{r}
svmdiabetes_poly3<-svm(DIABETICEV ~SALADSNO+ VIG10DMIN+HINOTCOVE+HOURSWRK+EDUC, data=train, kernel="polynomial",degree=3, cost=1, scale=TRUE)
